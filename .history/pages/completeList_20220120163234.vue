      ...
      <div class="cork-board">
        ...
        <div class="top-container">
          <ul class="btn-container">
            <li>
              <v-btn to="/todoList"><i class="fas fa-list-ul"></i></v-btn>
            </li>
          </ul>
        </div>
        <!-- top-container 終了 -->
        ...
        <div class="todo-card-container">
          ...
          >
            ...
            <v-card-actions>
              <v-btn elevation="2" color="error" v-on:click="returnTodoList(i)"
                >RETURN</v-btn
              >
...
.ribbon {
  ...
  margin: 1rem auto 0;
  position: relative;
  background-color: rgba(245, 229, 107, 1);
  color: #fff;
  line-height: 4rem;
  text-align: center;
}
...
.ribbon:before {
  ...
  border-top: 2rem solid rgba(245, 229, 107, 1);
  border-bottom: 2rem solid rgba(245, 229, 107, 1);
  ...
  .v-card {
    ...
    .masking-tape {
      ...
      background-image: radial-gradient(
          rgba(245, 229, 107, 0.8) 30%,
          transparent 30%
        ),
        radial-gradient(rgba(245, 229, 107, 0.8) 30%, transparent 30%);
